module "mysql_sg" {
    source = "git::https://github.com/Amarnath-G235/terraform-aws-security-group.git?ref=main"
...
# node is accepting traffic from vpc
...
# node is accepting traffic from Bastion
